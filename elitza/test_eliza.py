...
class ElizaTest(unittest.TestCase):
    ...
    def test_decomp_6(self):
        ...
        self.assertEqual(
            [["0", "a", "b"]], el._match_decomp(["*", "a"], ["0", "a", "b", "a"])
        )
    ...
    def test_decomp_9(self):
        el = eliza.Eliza()
        self.assertEqual(
            [["0"], ["b"]], el._match_decomp(["*", "a", "*"], ["0", "a", "b"])
        )
        self.assertEqual(
            [["0"], ["b", "c"]], el._match_decomp(["*", "a", "*"], ["0", "a", "b", "c"])
        )
    ...
    def test_syn_1(self):
        ...
        self.assertEqual(
            [["am"]], el._match_decomp(["a", "@be", "b"], ["a", "am", "b"])
        )
    ...
    def test_syn_3(self):
        ...
        self.assertIsNotNone(
            el._match_decomp(
                ["*", "i", "am", "@sad", "*"], ["its", "true", "i", "am", "unhappy"]
            )
        )
